DO $$ BEGIN CREATE TYPE channel_type AS ENUM ('eposnow', 'wix', 'deliveroo'); EXCEPTION WHEN duplicate_object THEN null; END $$;
DO $$ BEGIN CREATE TYPE user_role AS ENUM ('owner', 'admin', 'staff'); EXCEPTION WHEN duplicate_object THEN null; END $$;
DO $$ BEGIN CREATE TYPE sync_event_status AS ENUM ('pending', 'processing', 'completed', 'failed'); EXCEPTION WHEN duplicate_object THEN null; END $$;
DO $$ BEGIN CREATE TYPE alert_type AS ENUM ('low_stock', 'sync_error', 'channel_disconnected', 'system'); EXCEPTION WHEN duplicate_object THEN null; END $$;
